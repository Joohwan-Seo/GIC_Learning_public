...
class RobotEnv(Env):
    ...
    def impedance_control(self, action): # This one is Total compensation geometric impedance control
        ...
        # print('Jacobian Determinant', det_Jb)

        dq = self.robot_state.get_joint_velocity().reshape((-1,1))

        tau_cmd = Jb.T @ tau_tilde + G + C @ dq
