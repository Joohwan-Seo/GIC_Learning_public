...
class RobotEnv(Env):
    def __init__(self, robot_name = 'fanuc', env_type = 'square_PIH', max_time = 15, show_viewer = False, 
        ...
        if self.hole_ori == 'default':
            self.xd = np.array([0.6, 0.0, 0.10])
            self.Rd = np.array([[0, 1, 0],
                                [1, 0, 0],
                                [0, 0, -1]])
            
        elif self.hole_ori == 'default2':
    ...
    def load_xml(self):
        ...
        if self.robot_name == 'ur5e':
            ...
            if self.hole_ori == 'default':
                model_path = dir + "gic_env/mujoco_models/pih/pih_fanuc_testing.xml"
            elif self.hole_ori == 'default2':
    ...
    def get_expert_action(self):
        ...
        if self.ECGIC:
            ...
            if dis > 1:
                ...
                # print('case3')
                a0 = 0.9; a1 = 0.9; a2 = 2.0; a3 = 0.9; a4 = 0.9; a5 = 0.9
            elif z_part < 0.10:
                a0 = 2.0; a1 = 2.0; a2 = -0.9; a3 = 0.9; a4 = 0.9; a5 = 0.9
            else:
                # print('case4')
                a0 = 0.8; a1 = 0.8; a2 = -0.5; a3 = 0.8; a4 = 0.8; a5 = 0.8
...
if __name__ == "__main__":
    ...
    env_type = 'square_PIH'
    show_viewer = True
    RE = RobotEnv(robot_name, env_type, show_viewer = True, obs_type = 'feature', window_size = 1, hole_ori = 'default2', ECGIC = False, use_ext_force = False, testing = True, act_type = 'default')
    RE.test()
