...
if __name__ == "__main__":
    ...
    env_type = 'square_PIH'
    show_viewer = True
    RE = RobotEnvSeparatedBenchmark(robot_name, env_type, show_viewer = True, obs_type = 'pos', window_size = 1, hole_ori = 'default', ECGIC = False, use_ext_force = False, testing = True, act_type = 'minimal', reward_version = 'force_penalty')
    RE.test()
