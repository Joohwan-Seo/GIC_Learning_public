...
if __name__ == "__main__":
    ...
    variant = dict(
        ...
        trainer_kwargs=dict(
            ...
            policy_lr=1E-4, # worked well with 1e-4
            qf_lr=1E-4, # worked well with 1e-4
            reward_scale=1,
    ...
    setup_logger('Fanuc_GIC_ws_1_2x256_pos_feature_GIC', variant=variant, snapshot_mode = "gap", snapshot_gap = 5)
