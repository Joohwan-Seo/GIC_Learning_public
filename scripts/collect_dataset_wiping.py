...
def collect_traj(variant):
    ...
    if variant['env_name'] == 'default':
        print('========== Default ENV ===========')
        env = NormalizedBoxEnv(WipingEnv(show_viewer = False, 
        ...
        print('========== Benchmark ENV ===========')
        env = NormalizedBoxEnv(WipingEnvBenchmark(show_viewer = False, 
                                                 window_size = window_size,
                                                 use_ext_force = use_ext_force,
                                                 mixed_obs = mixed_obs,
                                                 ))
...
if __name__ == "__main__":
    ...
    file = open("./dataset/dataset_wiping_GIC_BC_GCEV_100.pkl","wb")
